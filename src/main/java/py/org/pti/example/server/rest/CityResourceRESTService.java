...
import py.org.pti.example.server.data.CityRepository;
import py.org.pti.example.server.model.City;
import py.org.pti.example.server.service.CityRegistration;
...
@Path("/cities")
@RequestScoped
public class CityResourceRESTService extends ResourceRESTService
{
    @Inject
    ...
    /**
     * <p>
     * Validates the given City variable and throws validation exceptions
     * based on the type of error. If the error is standard bean validation
     * errors then it will throw a ConstraintValidationException with the set of
     * the constraints violated.
     * </p>
     * <p>
     * If the error is caused because an existing city with the same name
    ...
    /**
     * Checks if a city with the same name address is already registered.
     * This is the only way to easily capture the
     * "@UniqueConstraint(columnNames = "name")" constraint from the City
     * class.
     * 
     * @param name
     *            The name to check
